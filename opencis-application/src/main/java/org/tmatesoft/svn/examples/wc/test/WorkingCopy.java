 ...
 * ====================================================================
 */
package org.tmatesoft.svn.examples.wc.test;
...
public class WorkingCopy {
    ...
    public static void main(String[] args) throws SVNException {
        ...
        try {
            repositoryURL = SVNURL.parseURIEncoded("https://hrm-koala.googlecode.com/svn/trunk/");
            //ef4GR4KB9mx8 
        } catch (SVNException e) {
            //
        }
        String name = "chencao0524@gmail.com";
        String password = "ef4GR4KB9mx8";
